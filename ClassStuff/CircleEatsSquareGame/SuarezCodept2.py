...
impact=False
while check:
    #so basically, as I understand it, you made a box and put it on screen and when you collide with the box it creates a...
    #condition called "crash" when there is "crash" the little guy can't move.
    #what i find interesting is while crash, you can move left, but not right, so its kinda like a one way door. 
    move=10
